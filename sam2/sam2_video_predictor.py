...
class SAM2VideoPredictor(SAM2Base):
    ...
    def _run_single_frame_inference(
        ...
        # Fill small interior holes in low-res mask logits (matches build_sam
        # `fill_hole_area` and sam2_video_predictor_legacy; leaving this disabled
        # caused fragmented / holey masks when using many prompt points).
